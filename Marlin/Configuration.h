...
#define STRING_CONFIG_H_AUTHOR "(Robert Steel, Dec 2019)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "STEEL PULSE"
...
//enabled this want to use bltouch as zmin.  BLTouch is plugged into zmax
...
#define Z_MIN_PROBE_ENDSTOP_INVERTING false // set to true to invert the logic of the probe.  RSTEEL - THIS WAS FALSE
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 250, 250, 35, 75 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_ACCELERATION      {3000 , 3000, 250, 1000 }
 ...
 *
 */
 //PER ERROR MESSAGES, CHANGING TO Z_MIN_PROBE_ENDSTOP
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -1.81   // Z offset: -below +above  [the nozzle] ***WILL NEED TO CHANGE FOR YOUR PRINTER***
...
//z max from matterhackers website
